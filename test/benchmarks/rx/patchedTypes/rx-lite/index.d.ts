...
declare namespace Rx {
    ...
    // export var Scheduler: SchedulerStatic; // TODO: <- This is plain up wrong, it is actually an object consisting on properties: animationFrame, asap, async and queue. 
