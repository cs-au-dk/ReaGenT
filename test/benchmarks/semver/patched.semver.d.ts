...
declare module SemVer {
     ...
     */
    export function prerelease(v: string | SemVer, loose?: boolean): (string | number)[] | null;
...
// Ranges
     ...
     */
    export function validRange(range: string | Range, loose?: boolean): string | null;
