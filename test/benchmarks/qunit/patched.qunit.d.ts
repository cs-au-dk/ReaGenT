...
interface QUnit {
     ...
     */
    extend: ((target: any, mixin: any) => void) | undefined;
     ...
     */
    module: undefined | {
        (name: string, hooks?: Hooks, nested?: (hooks: NestedHooks) => void): void
        (name: string, nested?: (hooks: NestedHooks) => void): void;
    };
     ...
     */
    only: ((name: string, callback: (assert: Assert) => void) => void) | undefined;
     ...
     */
    skip: undefined | ((name: string, callback?: (assert: Assert) => void)=> void);
     ...
     */
    stack: undefined | ((offset?: number) => string);
     ...
     * @param callback Function to close over assertions
     */
    test: undefined | ((name: string, callback: (assert: Assert) => void)=> void);
