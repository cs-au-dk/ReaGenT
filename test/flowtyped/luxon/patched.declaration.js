...
declare module "luxon" {
    ...
    declare export class Info {
        ...
        static features(): {
            intl: boolean,
            intlTokens: boolean,
            timezones: void // boolean; TODO i saw undefined.
        };
    ...
    declare export class Interval {
        ...
        difference(...intervals: Array<Interval>): Array<Interval>;
    ...
    declare export class Duration {
        ...
        toString(): ?string; // returns null if duration is invalid.
    }
    ...
    declare export class DateTime {
        ...
        until(other: DateTime): Interval | DateTime; // if invalid, it returns this instead of an Interval.
        valueOf(): number;
    }
}
