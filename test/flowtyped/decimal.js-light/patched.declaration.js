declare module 'decimal.js-light' {
    ...
    declare class Decimal {
         ...
         *
         */
        naturalExponential(): Decimal; // <- Typo. The .d.ts bundled with the library has the same typo...
         ...
         */
        static config(config: DecimalConfig): typeof Decimal;

        /**
         * Configure global settings for a Decimal constructor.
         */
        static set(config: DecimalConfig): typeof Decimal;
