...
type moment$MomentCreationData = {
    input: ?Object|number|Date|Array<number>|moment$Moment|string,
    format?: string,
    locale: Object,
    isUTC: bool,
    strict: bool,
...
declare class moment$LocaleData {
    ...
    week(moment: moment$Moment): number; // was string.
    invalidDate(): string;
...
declare class moment$Moment {
    static ISO_8601: Function;
    static RFC_2822: Function;
    ...
    static months(index: number): string;
    static weekdays(): string[];
    static weekdays(index: number): string;
    static weekdaysShort(): string[];
    static weekdaysShort(index: number): string;
    static weekdaysMin(): string[];
    static weekdaysMin(index: number): string;
}
