declare module "plow-js" {
    ...
    declare function $tail(path: Path, subject: Subject): Array<any>; // benign. Can return "null" if preconditions aren't met. In that case error is printed to stderr.
    ...
    ): /*(subject: Subject) => boolean*/ boolean;
    ...
    /*declare function $all( // benign: returned a number?
        ...statements: Array<Function>
    ): (subject: Subject) => Subject;*/
