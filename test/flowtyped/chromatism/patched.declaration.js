declare module 'chromatism' {
     ...
     * "hsl(44,100,61)"
     */
    declare export type CSSHSLColourMode = string; // It is a string, even the example in the JSDoc says it is a string.
     ...
     */
    // declare export type CIELUVColourMode = { L: number, u: number, v: number }; // Only in 2.6+
     ...
     */
    // declare export type CIELCHColourMode = { L: number, C: number, h: number }; // Only in 2.6+
     ...
     * { L: 53.23, C: 179.08, h: 12.17 }
     */
    // declare export type HSLUVColourMode = { hu: number, s: number, l: number }; // only in 2.6+
    ...
    declare export type ColourMode =
        ...
        | LMSColourMode
        | CIELABColourMode
        // | CIELUVColourMode // only in 2.6+
        // | CIELCHColourMode // only in 2.6+
        // | HSLUVColourMode; // only in 2.6+
    ...
    declare export type ColourObject = {
        ...
        // cieluv: CIELUVColourMode, // only in 2.6+
        // cielch: CIELCHColourMode, // only in 2.6+
        // hsluv: HSLUVColourMode, // only in 2.6+
    };
    ...
    declare export type ColourObjectArray = {
        ...
        // cieluv: Array<CIELUVColourMode>, only in 2.6+
        // cielch: Array<CIELCHColourMode>, only in 2.6+
        // hsluv: Array<HSLUVColourMode>, only in 2.6+
    };
     ...
     */
    /*declare export var TRANSFORMS: { // Only exists in 2.6+. And even then there is a mistake (here they are changed to Array<Array<number>> instead of the wrong Array<number>).
        BRADFORD: Array<Array<number>>,
        INVERSE_BRADFORD: Array<Array<number>>,
        SRGB_XYZ: Array<Array<number>>,
        INVERSE_SRGB_XYZ: Array<Array<number>>,
    };*/
     ...
     * @see {@link https://github.com/toish/chromatism/blob/master/README.md#generate-a-complementary-colour}
     */
    // declare export function uniformComplementary(colour: ColourMode): ColourObject; // Only exists in 3.0+
     ...
     * @see {@link https://github.com/toish/chromatism/blob/master/README.md#generate-an-array-of-triad-colours}
     */
    // declare export function uniformTriad(colour: ColourMode): ColourObjectArray; // Only exists in 3.0+
     ...
     * @see {@link https://github.com/toish/chromatism/blob/master/README.md#generate-an-array-of-tetrad-colours}
     */
    // declare export function uniformTetrad(colour: ColourMode): ColourObjectArray; // Only exists in 3.0+
     ...
     */
    // declare export function temperature(colour: ColourMode): number; // Only exists in 2.6+
}
