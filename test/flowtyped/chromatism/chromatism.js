(function (global, factory) {
        ...
        switch (to) {
            ...
            case "XYZ":
                ...
                var _M$map$map = M.map(function (m) {
                    ...
                    _M$map$map2 = slicedToArray(_M$map$map, 3),
                    X = _M$map$map2[0],
                    Y = _M$map$map2[1],
                    Z = _M$map$map2[2];
        ...
        switch (to) {
            ...
            case "rgb":
                ...
                var _linear$map$map = linear.map(function (C) {
                    ...
                    _linear$map$map2 = slicedToArray(_linear$map$map, 3),
    ...
    var index$2 = {
        ...
        complementary: complementary_1,
        contrast: contrast_1,
        contrastRatio: contrastRatio_1,
        convert: convert_1,
        difference: difference_1,
        fade: fade_1,
        greyscale: greyscale_1,
        hue: hue_1,
        invert: invert_1,
        invertLightness: invertLightness_1,
        mid: mid_1,
        multiply: multiply_1,
        ...
        var out = Object.keys(dependencies.operations).reduce(function (acc, key) {
            ...
            acc[key] = function () {
                ...
                if (chain && chain.colours) {
                    ...
                    return operation.apply(undefined, [dependencies].concat(toConsumableArray(clone), [chain ? chain.colour : undefined]));
                }
            };
            return acc;
        }, {});
    ...
    var helpers = {
        ...
        determineMode: function determineMode(colour) {
            for (var model in index) {
                if (!index.hasOwnProperty(model)) continue;
                if (index[model].test(colour)) return model;
            }
            return null;
        },
        ready: function ready(_ref, colour) {
            ...
            switch (Object.prototype.toString.call(colour)) {
                ...
                case "[object String]":
                    ...
                    out = Object.assign(out, api_1({ conversions: conversions, operations: operations, helpers: helpers }, constants, out));
                    return out;
